 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = abs((hoursDepart - hoursArrive) * 60 + minutesDepart - minutesArrive)
